...
typedef enum
{
	...
	NES_FIELD_PPU_SPR_UNIT_COUNT,
	NES_FIELD_PPU_SPRITE_ZERO_SELECTED,
...
{
	NES_SCALAR(NES_FIELD_PPU_SPRITE_YPOS , NES_PPUSprite, y,          SERIALIZE_WIRE_U8, 0),
	NES_SCALAR(NES_FIELD_PPU_SPRITE_XPOS , NES_PPUSprite, x,          SERIALIZE_WIRE_U8, 0),
	NES_SCALAR(NES_FIELD_PPU_SPRITE_INDEX, NES_PPUSprite, tile,       SERIALIZE_WIRE_U8, 0),
	NES_SCALAR(NES_FIELD_PPU_SPRITE_ATTRS, NES_PPUSprite, attributes, SERIALIZE_WIRE_U8, 0),
};
...
static const SerializeField nes_ppu_fields[] =
{
	...
	NES_SCALAR(NES_FIELD_PPU_TILE_ID,           NES_PPUState, background.tile,                    SERIALIZE_WIRE_U8,     0),
	NES_SCALAR(NES_FIELD_PPU_TILE_LO,           NES_PPUState, background.pattern_lo_latch,        SERIALIZE_WIRE_U8,     0),
	NES_SCALAR(NES_FIELD_PPU_ATR_B,             NES_PPUState, background.attribute_latch,         SERIALIZE_WIRE_U8,     0),
	NES_SCALAR(NES_FIELD_PPU_ATR_L0,            NES_PPUState, background.attribute_lo_latch,      SERIALIZE_WIRE_U8,     0),
	NES_SCALAR(NES_FIELD_PPU_ATR_L1,            NES_PPUState, background.attribute_hi_latch,      SERIALIZE_WIRE_U8,     0),
	NES_SCALAR(NES_FIELD_PPU_CHR_R0,            NES_PPUState, background.pattern_lo_shift,        SERIALIZE_WIRE_U16,    0),
	NES_SCALAR(NES_FIELD_PPU_CHR_R1,            NES_PPUState, background.pattern_hi_shift,        SERIALIZE_WIRE_U16,    0),
	NES_SCALAR(NES_FIELD_PPU_ATR_R0,            NES_PPUState, background.attribute_lo_shift,      SERIALIZE_WIRE_U8,     0),
	NES_SCALAR(NES_FIELD_PPU_ATR_R1,            NES_PPUState, background.attribute_hi_shift,      SERIALIZE_WIRE_U8,     0),
	NES_SCALAR(NES_FIELD_PPU_SPR0_2CYCLE_DELAY, NES_PPUState, sprite_zero_hit_pending,             SERIALIZE_WIRE_U8,     0),
	NES_SCALAR(NES_FIELD_PPU_SPR0_ENABLE,      NES_PPUState, sprite_zero_active,                  SERIALIZE_WIRE_U8,     0),
	NES_SCALAR(NES_FIELD_PPU_PPUCTRL,           NES_PPUState, control,                             SERIALIZE_WIRE_U8,     0),
	NES_SCALAR(NES_FIELD_PPU_PPUMASK,           NES_PPUState, mask,                                SERIALIZE_WIRE_U8,     0),
	NES_SCALAR(NES_FIELD_PPU_PPUSTATUS,         NES_PPUState, status,                              SERIALIZE_WIRE_U8,     0),
	NES_SCALAR(NES_FIELD_PPU_OAMADDR,           NES_PPUState, oam_addr,                            SERIALIZE_WIRE_U8,     0),
	NES_SCALAR(NES_FIELD_PPU_DATA_READ_BUF,     NES_PPUState, data_read_buffer,                    SERIALIZE_WIRE_U8,     0),
	NES_ARRAY(NES_FIELD_PPU_OAM,                NES_PPUState, primary_oam,                         SERIALIZE_WIRE_RECORD, NES_RECORD_PPU_SPRITE),
	NES_SCALAR(NES_FIELD_PPU_OAM_ADDRESS,       NES_PPUState, sprite_eval_address,                 SERIALIZE_WIRE_U16,    0),
	NES_SCALAR(NES_FIELD_PPU_OAM_LATCH,         NES_PPUState, sprite_eval_latch,                   SERIALIZE_WIRE_U8,     0),
	NES_SCALAR(NES_FIELD_PPU_SOAM_ADDRESS,      NES_PPUState, secondary_oam_address,               SERIALIZE_WIRE_U8,     0),
	NES_ARRAY(NES_FIELD_PPU_SOAM,               NES_PPUState, secondary_oam,                       SERIALIZE_WIRE_RECORD, NES_RECORD_PPU_SPRITE),
	NES_ARRAY(NES_FIELD_PPU_SPR_UNITS,          NES_PPUState, sprite_units,                       SERIALIZE_WIRE_RECORD, NES_RECORD_PPU_SPRITE_UNIT),
	NES_SCALAR(NES_FIELD_PPU_SPR_UNIT_COUNT,    NES_PPUState, sprite_unit_count,                  SERIALIZE_WIRE_U8,     0),
	NES_SCALAR(NES_FIELD_PPU_SPR_YPOS_LATCH,    NES_PPUState, sprite_y_latch,                     SERIALIZE_WIRE_U8,     0),
	NES_SCALAR(NES_FIELD_PPU_SPR_TILE_LATCH,    NES_PPUState, sprite_tile_latch,                  SERIALIZE_WIRE_U8,     0),
	NES_SCALAR(NES_FIELD_PPU_ADDRESS,           NES_PPUState, fetch_address,                      SERIALIZE_WIRE_U16,    0),
	NES_ARRAY(NES_FIELD_PPU_PRAM,               NES_PPUState, palette_ram,                        SERIALIZE_WIRE_U8,     0),
	NES_SCALAR(NES_FIELD_PPU_SPRITE_ZERO_SELECTED, NES_PPUState, sprite_zero_selected,            SERIALIZE_WIRE_U8,     0),
};
