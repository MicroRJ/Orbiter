...
NES_MapperInitParams;

#define NES_MAPPER_INIT_FUNC(NAME) b32 (NAME)(NES_Emulator *nes, NES_MapperInitParams *data)
#define NES_MAPPER_RSET_FUNC(NAME) b32 (NAME)(NES_Emulator *nes)
typedef NES_MAPPER_INIT_FUNC(*INITFUNC);
...
NES_MAPPER_INIT_FUNC(none_init);
NES_MAPPER_RSET_FUNC(none_reset);
