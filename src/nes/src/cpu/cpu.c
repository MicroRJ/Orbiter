...
static inline u32 cpu_fetch_byte(NES_Emulator *core)
{
...
static inline u32 cpu_fetch_word(NES_Emulator *core)
{
	u32 low = cpu_fetch_byte(core);
	u32 high = cpu_fetch_byte(core);
	return low | (high << 8);
}
...
static inline u32 cpu_address_zero_page(NES_Emulator *core)
{
	return cpu_fetch_byte(core);
}

static inline u32 cpu_address_zero_page_x(NES_Emulator *core)
{
	return (cpu_fetch_byte(core) + core->core.cpu.X) & 0xFF;
}

static inline u32 cpu_address_zero_page_y(NES_Emulator *core)
{
	return (cpu_fetch_byte(core) + core->core.cpu.Y) & 0xFF;
}

static inline u32 cpu_address_absolute(NES_Emulator *core)
{
	return cpu_fetch_word(core);
}

static inline CPU_IndexedAddress cpu_address_absolute_x(NES_Emulator *core)
{
	return cpu_index_address(cpu_fetch_word(core), core->core.cpu.X);
}

static inline CPU_IndexedAddress cpu_address_absolute_y(NES_Emulator *core)
{
	return cpu_index_address(cpu_fetch_word(core), core->core.cpu.Y);
}

static inline u32 cpu_address_indirect_x(NES_Emulator *core)
{
	u32 pointer = (cpu_fetch_byte(core) + core->core.cpu.X) & 0xFF;
	return cpu_read_zero_page_word(core, pointer);
}

static inline CPU_IndexedAddress cpu_address_indirect_y(NES_Emulator *core)
{
	u32 pointer = cpu_fetch_byte(core);
	u32 base = cpu_read_zero_page_word(core, pointer);
	return cpu_index_address(base, core->core.cpu.Y);
}

static inline u32 cpu_address_jmp_indirect(NES_Emulator *core)
{
	u32 pointer = cpu_fetch_word(core);
...
{
	return !!(core->core.cpu.P & cpu_status_mask(flag));
}
...
{
	core->core.cpu.P = (u8)((status | cpu_status_mask(CPU_STAT_1)) & ~cpu_status_mask(CPU_STAT_B));
}
...
{
	core->core.cpu.A = (u8)(value);
	core->core.cpu.P = (u8)(cpu_status_with_negative_and_zero(core->core.cpu.P, core->core.cpu.A));
}

static inline void cpu_load_x(NES_Emulator *core, u32 value)
{
	core->core.cpu.X = (u8)(value);
	core->core.cpu.P = (u8)(cpu_status_with_negative_and_zero(core->core.cpu.P, core->core.cpu.X));
}

static inline void cpu_load_y(NES_Emulator *core, u32 value)
{
	core->core.cpu.Y = (u8)(value);
	core->core.cpu.P = (u8)(cpu_status_with_negative_and_zero(core->core.cpu.P, core->core.cpu.Y));
}

static inline void cpu_compare(NES_Emulator *core, u32 left, u32 right)
{
	u32 status = cpu_status_with_flag(core->core.cpu.P, CPU_STAT_C, left >= right);
	core->core.cpu.P = (u8)(cpu_status_with_negative_and_zero(status, left - right));
}
...
static inline void cpu_add_with_carry(NES_Emulator *core, u32 value)
{
	...
	core->core.cpu.A = (u8)(result);
	core->core.cpu.P = (u8)(cpu_status_with_negative_and_zero(status, cpu->A));
}
...
{
	core->core.cpu.A = (u8)(core->core.cpu.A & value);
	core->core.cpu.P = (u8)(cpu_status_with_negative_and_zero(core->core.cpu.P, core->core.cpu.A));
}
...
{
	u32 status = cpu_status_with_flag(core->core.cpu.P, CPU_STAT_Z, (core->core.cpu.A & value) == 0);
	status = cpu_status_with_flag(status, CPU_STAT_V, value & 0x40);
	core->core.cpu.P = (u8)(cpu_status_with_flag(status, CPU_STAT_N, value & 0x80));
}

static inline u32 cpu_shift_left(NES_Emulator *core, u32 value)
{
	u32 status = cpu_status_with_flag(core->core.cpu.P, CPU_STAT_C, value & 0x80);
	value = (value << 1) & 0xFF;
	core->core.cpu.P = (u8)(cpu_status_with_negative_and_zero(status, value));
	return value;
}

static inline u32 cpu_shift_right(NES_Emulator *core, u32 value)
{
	u32 status = cpu_status_with_flag(core->core.cpu.P, CPU_STAT_C, value & 0x01);
	value = (value >> 1) & 0xFF;
	core->core.cpu.P = (u8)(cpu_status_with_negative_and_zero(status, value));
	return value;
}
...
{
	value = (value + 1) & 0xFF;
	core->core.cpu.P = (u8)(cpu_status_with_negative_and_zero(core->core.cpu.P, value));
	return value;
}
...
{
	NES_CPUState *cpu = &core->core.cpu;
	i32 offset = (i8)cpu_fetch_byte(core);
	u32 cycles = 2;

	if (condition)
	{
		u32 previous_pc = cpu->PC;
		core->core.cpu.PC = (u16)(cpu->PC + offset);
		cycles += 1;
...
static void nes_cpu_interrupt(NES_Emulator *core, u32 address)
{
	...
	core->core.cpu.P = (u8)(cpu->P | cpu_status_mask(CPU_STAT_I));
	core->core.cpu.PC = (u16)(address);
}
...
{
	NES_CPUState *cpu = &core->core.cpu;
	core->core.cpu.A = (u8)(0);
	core->core.cpu.X = (u8)(0);
	core->core.cpu.Y = (u8)(0);
	core->core.cpu.S = (u8)(0xFD);
	core->core.cpu.P = (u8)(cpu_status_mask(CPU_STAT_I) | cpu_status_mask(CPU_STAT_1));
	core->core.cpu.PC = (u16)(cpu_read_word(core, RESET_VECTOR));
}
...
u32 nes_cpu_step(NES_Emulator *core)
{
	...
	{
		// Load accumulator
		case 0xA9: cpu_load_a(core, cpu_fetch_byte(core)); cycles = 2; break;
		case 0xA5: cpu_load_a(core, cpu_read(core, cpu_address_zero_page(core))); cycles = 3; break;
		case 0xB5: cpu_load_a(core, cpu_read(core, cpu_address_zero_page_x(core))); cycles = 4; break;
		case 0xAD: cpu_load_a(core, cpu_read(core, cpu_address_absolute(core))); cycles = 4; break;
		...
		// Load X
		case 0xA2: cpu_load_x(core, cpu_fetch_byte(core)); cycles = 2; break;
		case 0xA6: cpu_load_x(core, cpu_read(core, cpu_address_zero_page(core))); cycles = 3; break;
		case 0xB6: cpu_load_x(core, cpu_read(core, cpu_address_zero_page_y(core))); cycles = 4; break;
		case 0xAE: cpu_load_x(core, cpu_read(core, cpu_address_absolute(core))); cycles = 4; break;
		...
		// Load Y
		case 0xA0: cpu_load_y(core, cpu_fetch_byte(core)); cycles = 2; break;
		case 0xA4: cpu_load_y(core, cpu_read(core, cpu_address_zero_page(core))); cycles = 3; break;
		case 0xB4: cpu_load_y(core, cpu_read(core, cpu_address_zero_page_x(core))); cycles = 4; break;
		case 0xAC: cpu_load_y(core, cpu_read(core, cpu_address_absolute(core))); cycles = 4; break;
		...
		// Store registers
		case 0x85: cpu_write(core, cpu_address_zero_page(core), cpu->A); cycles = 3; break;
		case 0x95: cpu_write(core, cpu_address_zero_page_x(core), cpu->A); cycles = 4; break;
		case 0x8D: cpu_write(core, cpu_address_absolute(core), cpu->A); cycles = 4; break;
		...
		case 0x86: cpu_write(core, cpu_address_zero_page(core), cpu->X); cycles = 3; break;
		case 0x96: cpu_write(core, cpu_address_zero_page_y(core), cpu->X); cycles = 4; break;
		case 0x8E: cpu_write(core, cpu_address_absolute(core), cpu->X); cycles = 4; break;
		case 0x84: cpu_write(core, cpu_address_zero_page(core), cpu->Y); cycles = 3; break;
		case 0x94: cpu_write(core, cpu_address_zero_page_x(core), cpu->Y); cycles = 4; break;
		case 0x8C: cpu_write(core, cpu_address_absolute(core), cpu->Y); cycles = 4; break;

		// Add with carry
		case 0x69: cpu_add_with_carry(core, cpu_fetch_byte(core)); cycles = 2; break;
		case 0x65: cpu_add_with_carry(core, cpu_read(core, cpu_address_zero_page(core))); cycles = 3; break;
		case 0x75: cpu_add_with_carry(core, cpu_read(core, cpu_address_zero_page_x(core))); cycles = 4; break;
		case 0x6D: cpu_add_with_carry(core, cpu_read(core, cpu_address_absolute(core))); cycles = 4; break;
		...
		// Subtract with carry
		case 0xE9: cpu_subtract_with_carry(core, cpu_fetch_byte(core)); cycles = 2; break;
		case 0xE5: cpu_subtract_with_carry(core, cpu_read(core, cpu_address_zero_page(core))); cycles = 3; break;
		case 0xF5: cpu_subtract_with_carry(core, cpu_read(core, cpu_address_zero_page_x(core))); cycles = 4; break;
		case 0xED: cpu_subtract_with_carry(core, cpu_read(core, cpu_address_absolute(core))); cycles = 4; break;
		...
		// Logical operations
		case 0x29: cpu_and(core, cpu_fetch_byte(core)); cycles = 2; break;
		case 0x25: cpu_and(core, cpu_read(core, cpu_address_zero_page(core))); cycles = 3; break;
		case 0x35: cpu_and(core, cpu_read(core, cpu_address_zero_page_x(core))); cycles = 4; break;
		case 0x2D: cpu_and(core, cpu_read(core, cpu_address_absolute(core))); cycles = 4; break;
		...
		case 0x09: cpu_or(core, cpu_fetch_byte(core)); cycles = 2; break;
		case 0x05: cpu_or(core, cpu_read(core, cpu_address_zero_page(core))); cycles = 3; break;
		case 0x15: cpu_or(core, cpu_read(core, cpu_address_zero_page_x(core))); cycles = 4; break;
		case 0x0D: cpu_or(core, cpu_read(core, cpu_address_absolute(core))); cycles = 4; break;
		...
		case 0x49: cpu_xor(core, cpu_fetch_byte(core)); cycles = 2; break;
		case 0x45: cpu_xor(core, cpu_read(core, cpu_address_zero_page(core))); cycles = 3; break;
		case 0x55: cpu_xor(core, cpu_read(core, cpu_address_zero_page_x(core))); cycles = 4; break;
		case 0x4D: cpu_xor(core, cpu_read(core, cpu_address_absolute(core))); cycles = 4; break;
		...
		case 0x24: cpu_test_bits(core, cpu_read(core, cpu_address_zero_page(core))); cycles = 3; break;
		case 0x2C: cpu_test_bits(core, cpu_read(core, cpu_address_absolute(core))); cycles = 4; break;

		// Compare registers
		case 0xC9: cpu_compare(core, cpu->A, cpu_fetch_byte(core)); cycles = 2; break;
		case 0xC5: cpu_compare(core, cpu->A, cpu_read(core, cpu_address_zero_page(core))); cycles = 3; break;
		case 0xD5: cpu_compare(core, cpu->A, cpu_read(core, cpu_address_zero_page_x(core))); cycles = 4; break;
		case 0xCD: cpu_compare(core, cpu->A, cpu_read(core, cpu_address_absolute(core))); cycles = 4; break;
		...
		case 0xE0: cpu_compare(core, cpu->X, cpu_fetch_byte(core)); cycles = 2; break;
		case 0xE4: cpu_compare(core, cpu->X, cpu_read(core, cpu_address_zero_page(core))); cycles = 3; break;
		case 0xEC: cpu_compare(core, cpu->X, cpu_read(core, cpu_address_absolute(core))); cycles = 4; break;
		case 0xC0: cpu_compare(core, cpu->Y, cpu_fetch_byte(core)); cycles = 2; break;
		case 0xC4: cpu_compare(core, cpu->Y, cpu_read(core, cpu_address_zero_page(core))); cycles = 3; break;
		case 0xCC: cpu_compare(core, cpu->Y, cpu_read(core, cpu_address_absolute(core))); cycles = 4; break;

		// Shifts and rotates
		case 0x0A: core->core.cpu.A = (u8)(cpu_shift_left(core, cpu->A)); cycles = 2; break;
		case 0x06: address = cpu_address_zero_page(core); value = cpu_shift_left(core, cpu_read(core, address)); cpu_write(core, address, value); cycles = 5; break;
		case 0x16: address = cpu_address_zero_page_x(core); value = cpu_shift_left(core, cpu_read(core, address)); cpu_write(core, address, value); cycles = 6; break;
		case 0x0E: address = cpu_address_absolute(core); value = cpu_shift_left(core, cpu_read(core, address)); cpu_write(core, address, value); cycles = 6; break;
		...
		case 0x4A: core->core.cpu.A = (u8)(cpu_shift_right(core, cpu->A)); cycles = 2; break;
		case 0x46: address = cpu_address_zero_page(core); value = cpu_shift_right(core, cpu_read(core, address)); cpu_write(core, address, value); cycles = 5; break;
		case 0x56: address = cpu_address_zero_page_x(core); value = cpu_shift_right(core, cpu_read(core, address)); cpu_write(core, address, value); cycles = 6; break;
		case 0x4E: address = cpu_address_absolute(core); value = cpu_shift_right(core, cpu_read(core, address)); cpu_write(core, address, value); cycles = 6; break;
		...
		case 0x2A: core->core.cpu.A = (u8)(cpu_rotate_left(core, cpu->A)); cycles = 2; break;
		case 0x26: address = cpu_address_zero_page(core); value = cpu_rotate_left(core, cpu_read(core, address)); cpu_write(core, address, value); cycles = 5; break;
		case 0x36: address = cpu_address_zero_page_x(core); value = cpu_rotate_left(core, cpu_read(core, address)); cpu_write(core, address, value); cycles = 6; break;
		case 0x2E: address = cpu_address_absolute(core); value = cpu_rotate_left(core, cpu_read(core, address)); cpu_write(core, address, value); cycles = 6; break;
		...
		case 0x6A: core->core.cpu.A = (u8)(cpu_rotate_right(core, cpu->A)); cycles = 2; break;
		case 0x66: address = cpu_address_zero_page(core); value = cpu_rotate_right(core, cpu_read(core, address)); cpu_write(core, address, value); cycles = 5; break;
		case 0x76: address = cpu_address_zero_page_x(core); value = cpu_rotate_right(core, cpu_read(core, address)); cpu_write(core, address, value); cycles = 6; break;
		case 0x6E: address = cpu_address_absolute(core); value = cpu_rotate_right(core, cpu_read(core, address)); cpu_write(core, address, value); cycles = 6; break;
		...
		case 0xE6: address = cpu_address_zero_page(core); value = cpu_increment(core, cpu_read(core, address)); cpu_write(core, address, value); cycles = 5; break;
		case 0xF6: address = cpu_address_zero_page_x(core); value = cpu_increment(core, cpu_read(core, address)); cpu_write(core, address, value); cycles = 6; break;
		case 0xEE: address = cpu_address_absolute(core); value = cpu_increment(core, cpu_read(core, address)); cpu_write(core, address, value); cycles = 6; break;
		...
		case 0xC6: address = cpu_address_zero_page(core); value = cpu_decrement(core, cpu_read(core, address)); cpu_write(core, address, value); cycles = 5; break;
		case 0xD6: address = cpu_address_zero_page_x(core); value = cpu_decrement(core, cpu_read(core, address)); cpu_write(core, address, value); cycles = 6; break;
		case 0xCE: address = cpu_address_absolute(core); value = cpu_decrement(core, cpu_read(core, address)); cpu_write(core, address, value); cycles = 6; break;
		...
		case 0x9A: core->core.cpu.S = (u8)(cpu->X); cycles = 2; break;
		case 0xE8: core->core.cpu.X = (u8)(cpu->X + 1); core->core.cpu.P = (u8)(cpu_status_with_negative_and_zero(cpu->P, cpu->X)); cycles = 2; break;
		case 0xCA: core->core.cpu.X = (u8)(cpu->X - 1); core->core.cpu.P = (u8)(cpu_status_with_negative_and_zero(cpu->P, cpu->X)); cycles = 2; break;
		case 0xC8: core->core.cpu.Y = (u8)(cpu->Y + 1); core->core.cpu.P = (u8)(cpu_status_with_negative_and_zero(cpu->P, cpu->Y)); cycles = 2; break;
		case 0x88: core->core.cpu.Y = (u8)(cpu->Y - 1); core->core.cpu.P = (u8)(cpu_status_with_negative_and_zero(cpu->P, cpu->Y)); cycles = 2; break;

		// Status flags
		case 0x18: core->core.cpu.P = (u8)(cpu->P & ~cpu_status_mask(CPU_STAT_C)); cycles = 2; break;
		case 0x38: core->core.cpu.P = (u8)(cpu->P | cpu_status_mask(CPU_STAT_C)); cycles = 2; break;
		case 0x58: core->core.cpu.P = (u8)(cpu->P & ~cpu_status_mask(CPU_STAT_I)); cycles = 2; break;
		case 0x78: core->core.cpu.P = (u8)(cpu->P | cpu_status_mask(CPU_STAT_I)); cycles = 2; break;
		case 0xD8: core->core.cpu.P = (u8)(cpu->P & ~cpu_status_mask(CPU_STAT_D)); cycles = 2; break;
		case 0xF8: core->core.cpu.P = (u8)(cpu->P | cpu_status_mask(CPU_STAT_D)); cycles = 2; break;
		case 0xB8: core->core.cpu.P = (u8)(cpu->P & ~cpu_status_mask(CPU_STAT_V)); cycles = 2; break;
		...
		// Control flow
		case 0x4C: core->core.cpu.PC = (u16)(cpu_address_absolute(core)); cycles = 3; break;
		case 0x6C: core->core.cpu.PC = (u16)(cpu_address_jmp_indirect(core)); cycles = 5; break;
		case 0x20: address = cpu_address_absolute(core); cpu_push_word(core, cpu->PC - 1); core->core.cpu.PC = (u16)(address); cycles = 6; break;
		case 0x60: core->core.cpu.PC = (u16)(cpu_pop_word(core) + 1); cycles = 6; break;
		case 0x40: cpu_restore_status(core, cpu_pop_byte(core)); core->core.cpu.PC = (u16)(cpu_pop_word(core)); cycles = 6; break;
		case 0x00:
			cpu_push_word(core, cpu->PC + 1);
			cpu_push_byte(core, cpu_status_for_push(cpu, true));
			core->core.cpu.P = (u8)(cpu->P | cpu_status_mask(CPU_STAT_I));
			core->core.cpu.PC = (u16)(cpu_read_word(core, 0xFFFE));
			cycles = 7;
			break;
